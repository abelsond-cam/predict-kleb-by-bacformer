#!/bin/bash
#SBATCH --job-name=finetune_kp_ceftriaxone_from_pt
#SBATCH --output=finetune_kp_ceftriaxone_from_pt_%A_%a.out
#SBATCH --error=finetune_kp_ceftriaxone_from_pt_%A_%a.err
...
echo "Finetuned model from .pt files (direct PyTorch tensors, no parquet)"
uv run python src/bacotype/tl/train_amr_from_pt.py  \
--train-data-dir /home/dca36/rds/rds-floto-bacterial-4k08a2yyQLw/david/processed/ast_training_pt/train \
--val-data-dir /home/dca36/rds/rds-floto-bacterial-4k08a2yyQLw/david/processed/ast_training_pt/validate \
